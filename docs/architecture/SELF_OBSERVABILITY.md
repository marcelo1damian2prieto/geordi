...
closed condition type, stateless result status, and bounded unavailable reason. Policy
and SLO IDs/names, service identity, threshold, observed burn rate, timestamps, exact
range, provider syntax/payloads, and exception text are excluded.
